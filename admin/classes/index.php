        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT c.*,cc.name as `course` from `class_list` c inner join `course_list` cc on c.course_id = cc.id where c.delete_flag = 0 order by cc.`name` asc,c.`name` asc ");
