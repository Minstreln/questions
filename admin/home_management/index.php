<div class="content py-3">
	<div class="card card-outline card-primary shadow rounded-0">
		<div class="card-header">
			<h5 class="card-title"><b>Home Content Management</b></h5>
		</div>
		<div class="card-body">
			<div class="container-fluid">
				<form action="" id="content-form">
					<div class="row">
						<div class="col-lg-12">
							<textarea name="content[home]" id="" cols="30" rows="10" class="form-control form-control-sm summernote"><?= file_get_contents(base_app.'home.html') ?></textarea>
						</div>
					</div>
				</form>
			</div>
